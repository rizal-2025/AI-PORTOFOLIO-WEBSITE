      ...
      <PageContainer>
        ...
        <article className="mt-10 grid min-w-0 gap-8 border border-slate-800 bg-slate-950 p-6 sm:p-8 lg:grid-cols-[1fr_auto] lg:items-end">
          ...
          <div className="min-w-0 flex flex-col gap-3 sm:flex-row lg:flex-col">
            <ButtonLink href="/demo/aura" className="max-w-full">Coba Demo Live</ButtonLink>
            <ButtonLink href="/projects/aura" variant="secondary" className="max-w-full">Lihat Studi Kasus</ButtonLink>
          </div>
        </article>
      </PageContainer>
    </section>
