...
export function PageHeader({ eyebrow, title, description }: PageHeaderProps) {
  return (
    <header className="relative isolate overflow-hidden border-b border-zinc-800 bg-[#07070b]">
      ...
      <div className="mx-auto w-full max-w-7xl px-5 py-16 sm:px-8 sm:py-24 lg:px-10">
        ...
        <h1 className="mt-5 max-w-4xl text-4xl font-semibold leading-tight tracking-[-0.035em] text-zinc-50 sm:text-6xl">
          {title}
        </h1>
